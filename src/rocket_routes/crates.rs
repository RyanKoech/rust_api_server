...
pub async fn create_crate(mut db: Connection<DbConn>, _user: User, new_crate: Json<NewCrate>) -> Result<Custom<Value>, Custom<Value>> {
...
pub async fn update_crate(mut db: Connection<DbConn>, _user: User, id: i32, a_crate: Json<Crate>) -> Result<Value, Custom<Value>> {
...
pub async fn delete_crate(mut db: Connection<DbConn>, _user: User, id: i32) -> Result<NoContent, Custom<Value>> {
